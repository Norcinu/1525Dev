...
extern "C" DllExport unsigned char * AddHashToFile(char * filename);
extern "C" DllExport unsigned char * CalcHashFromFile(char * filename);
extern "C" DllExport bool CheckHash(char * filename);
extern "C" DllExport bool CheckFileType(char * filename);
extern "C" DllExport char * HashToHex(unsigned char * hash);
